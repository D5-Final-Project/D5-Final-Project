...
(코드 실행하면서 사용한 라이브러리 적어두긴했으나 중간중간 빠뜨린게 있을수있습니다..^^)

openai api가 결제해서 사용해야하는 방식이라 많이 사용시에 트래픽 초과될수있으니
테스트용도로 적당히 사용부탁드려용
'''
...
# OpenAI API key
os.environ["OPENAI_API_KEY"] = "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"
